...
public class CurrentWeather implements Parcelable
{
    ...
    @Expose
    private List<CurrentWeather> fCurrentWeather;
    @SerializedName("base")
    @Expose
    private String base;
    @SerializedName("main")
    ...
    public final static Creator<CurrentWeather> CREATOR = new Creator<CurrentWeather>() {
        ...
        public CurrentWeather createFromParcel(android.os.Parcel in) {
    ...
    protected CurrentWeather(android.os.Parcel in) {
        this.coord = ((Coord) in.readValue((Coord.class.getClassLoader())));
        in.readList(this.fCurrentWeather, (CurrentWeather.class.getClassLoader()));
    ...
    public List<CurrentWeather> getWeather() {
        return fCurrentWeather;
    }

    public void setWeather(List<CurrentWeather> pCurrentWeather) {
        this.fCurrentWeather = pCurrentWeather;
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        dest.writeList(fCurrentWeather);
